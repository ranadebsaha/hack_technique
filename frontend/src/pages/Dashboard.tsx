...
const UserDashboard = () => {
  ...
  const submitServiceRequest = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const resService = await fetch("http://65.20.81.114:5000/cyber-bandhu/service", {
        method: "POST",
      ...
      const resUserUpdate = await fetch(`http://65.20.81.114:5000/cyber-bandhu/user/${user._id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json", authorization: `Bearer ${token}` },
